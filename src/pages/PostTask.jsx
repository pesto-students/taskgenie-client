  ...
  return (
    <>
      <Container>
        ...
        {/* Stepper */}
          <StyledStepper orientation='horizontal'  connector={<QontoConnector />}>
            <Step>1</Step>
            <Step>2</Step>
          </StyledStepper>
        {/* Main */}
              ...
              <FormContainer
                ...
                <Stack gap={'1rem'} alignItems={'center'}>
                  ...
                  <FormControl>
                    ...
                    <TextField name="title" required type='text' placeholder='Enter the title of task here' sx={{width:'100%'}}/>
                  </FormControl>
